...
public class Login extends HttpServlet
{
    /*static {
        ...
        System.out.println("Blitzkriegbop!");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        Pessoa user = null;
        String email = request.getParameter("txtUsuario"); // Pega o Login vindo do formulario
        String senha = request.getParameter("txtSenha"); //Pega a senha vinda do formulario

        try
        {
            PessoaDAO dao = new PessoaDAO(); //cria uma instancia do DAO usuario
            user = dao.getPessoa(email, senha);
        }
        catch (Exception e)
        {
        ...
        else
        {
            ...
            out.println("alert('Dados não cadastrados');");
